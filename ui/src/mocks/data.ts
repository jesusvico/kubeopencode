...
export const mockAgents: Agent[] = [
  ...
  },
  {
    ...
    namespace: 'default',
    profile: 'KubeOpenCode agent — PR review, refactoring, dependency updates, GitHub and Slack responses, community operations, documentation generation, release management, security scanning, and cross-repository coordination',
    templateRef: { name: 'standard-base' },
    executorImage: 'quay.io/kubeopencode/kubeopencode-agent-devbox:latest',
    agentImage: 'quay.io/kubeopencode/kubeopencode-agent-opencode:latest',
    workspaceDir: '/workspace',
    ...
    serverStatus: {
      deploymentName: 'kubeopencode-agent-server',
      serviceName: 'kubeopencode-agent',
      url: 'http://kubeopencode-agent.default.svc.cluster.local:4096',
      ready: true,
      port: 4096,
      suspended: false,
    },
    credentials: [
      { name: 'github-token', secretRef: 'github-creds', env: 'GITHUB_TOKEN' },
      { name: 'anthropic-key', secretRef: 'ai-credentials', env: 'ANTHROPIC_API_KEY' },
      { name: 'slack-token', secretRef: 'slack-creds', env: 'SLACK_BOT_TOKEN' },
    ],
    contexts: [
      { name: 'coding-standards', type: 'Text', description: 'Organization coding standards and best practices' },
      { name: 'source', type: 'Git', mountPath: '/workspace/source', description: 'Main application repository' },
      { name: 'api-docs', type: 'URL', description: 'Internal API documentation' },
      { name: 'slack-context', type: 'Text', description: 'Slack channel guidelines and response templates' },
      { name: 'release-runbook', type: 'ConfigMap', description: 'Release management procedures' },
    ],
    labels: { team: 'platform', tier: 'core', role: 'multi-purpose', 'kubeopencode.io/agent-template': 'standard-base' },
  },
  {
    name: 'platform-agent',
    namespace: 'platform',
